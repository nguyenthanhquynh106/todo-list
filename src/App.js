...
class App extends React.Component {
  ...
  componentDidMount() {
    const list = JSON.parse(localStorage.getItem('tasks')) ? JSON.parse(localStorage.getItem('tasks')) : []
  ...
  onChecked = id => {
    let { tasks } = this.state
    let list = JSON.parse(localStorage.getItem('tasks')) ? JSON.parse(localStorage.getItem('tasks')) : []
